      ...
      <AnimatePresence mode="wait">
        ...
        >
          ...
          <div
            className="absolute inset-0"
            style={{
              //background: 'linear-gradient(to right, rgba(210, 216, 242, 0.95) 0%, rgba(212, 220, 255, 0.75) 50%, rgba(255, 255, 255, 0.5) 100%)',
              background: 'linear-gradient(to right, rgba(210, 216, 242, 0.95) 0%, rgba(255, 255, 255, 0.88) 50%, rgba(202, 212, 255, 0.85) 100%)',
