...
export function HeroCarousel() {
  ...
  return (
    <section className="relative h-[85vh] min-h-[600px] bg-slate-300 overflow-hidden"> 
      {/* Top Title 950*/}
      <motion.div
        initial={{ opacity: 0, y: -20 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.8, delay: 0.5 }}
        className="absolute top-8 left-1/2 -translate-x-1/2 z-30 text-center"
      >
        <p
          style={{
            fontSize: '16px',
      ...
      <AnimatePresence initial={false} custom={direction} mode="wait">
        ...
        >
          ...
          <div
            className="absolute inset-0"
            style={{
              //background: 'linear-gradient(to right, rgba(2, 6, 23, 0.95) 0%, rgba(2, 6, 23, 0.85) 40%, rgba(2, 6, 23, 0.5) 70%, rgba(2, 6, 23, 0.3) 100%)', //蒙板
          ...
          <AnimatePresence initial={false} custom={direction} mode="wait">
            ...
            >
              ...
              >
                ...
                <motion.button
                  className="group relative px-10 py-4 bg-gradient-to-r from-orange-400 to-orange-500 text-white rounded-md overflow-hidden shadow-lg hover:shadow-xl"
                  style={{
                    fontSize: '14px',
                    fontWeight: 500,
                    letterSpacing: '0.5px',
                ...
                {currentSlide.cardImages.map((image, index) => (
                  ...
                  >
                    ...
                    <div
                      className="absolute inset-0"
                      style={{
                        background: 'linear-gradient(180deg, rgba(255,255,255,0) 0%, rgba(79, 195, 247, 0.1) 100%)',
                      }}
                    />
                  </motion.div>
                ))}
      ...
      >
        <div
          ...
          style={{
            ...
            boxShadow: '0 4px 6px rgba(79, 195, 247, 0.15)',
          }}
        >
